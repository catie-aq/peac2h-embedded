function init(Survey, noUiSlider) {
    var widget = {
      name: "nouislidertlxgrad",
      title: "Slider visuel analogique gradué",
      iconName: "icon-right",
      widgetIsLoaded: function () {
        return typeof noUiSlider != "undefined";
      },
      isFit: function (question) {
        return question.getType() === "nouislidertlxgrad";
      },
      htmlTemplate: "<div class='slider-tlx-grad'><div></div></div>",
      activatedByChanged: function (activatedBy) {
        Survey.JsonObject.metaData.addClass("nouislidertlxgrad", [], null, "empty");
        Survey.JsonObject.metaData.addProperties("nouislidertlxgrad", []);
  
        Survey.Serializer.addProperty("nouislidertlxgrad", {
